...
To install OpenSSH, you need to have superuser permissions on the remote server. The installation process varies depending on the Linux distribution you are using. On Ubuntu/Linux Mint, you can install OpenSSH by running the following command in the terminal.

### OpenSSH Server installation

<CodeGroup show-lines="true" tabs={["Ubuntu","CentOS"]}>
  ```bash Ubuntu
