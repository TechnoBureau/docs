...
description: >-
  ...
  HashiCorp. It is used to define and provision the complete infrastructure
  using an easy-to-learn declarative language.
...
<CodeGroup default-tab="0" show-lines="true" tabs={["Debian/Ubuntu","Linux"]}>
  ```bash Debian/Ubuntu
